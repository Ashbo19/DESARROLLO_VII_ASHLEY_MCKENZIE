...
$infoPersona1 = ["nombre" => "Ashley", "edad" => 23];
$infoPersona2 = ["ciudad" => "Panama", "profesion" => "Licenciada"];
...
$misComidas = ["Hamburguesa", "Coditos", "Ensalada"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Pizza", "Hot dog", "Sushi"]; // Reemplaza con las comidas favoritas de tu amigo
