...
$colorUsuario = "rosado"; // Cambia este color para probar diferentes resultados
...
$diasBuscar = ["lunes", "domingo", "festivo","Juernes"];
...
$personas = [
    ...
    ["nombre" => "Eyleen", "edad" => 35],
    ["nombre" => "Angie", "edad" => 22]
];

$buscarPersona = ["nombre" => "Angie", "edad" => 22];
