...
$nombres = ["Ashley", "Carlos", "Eyleen","Angie","Virginia"];
$apellidos = ["Mc kenzie", "Bonilla", "Laurent","Diaz","Rodriguez"];
...
$productosConDescuento = array_map(function($producto) {
    $producto['precio_descuento'] = $producto['precio'] * 0.50; // 50% de descuento
    return $producto;
}, $productos);
