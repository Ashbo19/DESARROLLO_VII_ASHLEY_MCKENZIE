...
$fechaFormateada = date("l, j \of F \of Y");
...
$fechaFin = date("2026-01-01"); // Fecha actual
$diasTranscurridos = diasEntre($fechaInicio, $fechaFin);

echo "</br>Días transcurridos desde el $fechaInicio hasta el 2026: $diasTranscurridos días</br>";
